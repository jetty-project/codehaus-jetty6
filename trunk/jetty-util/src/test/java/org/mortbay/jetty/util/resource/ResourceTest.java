...
package org.mortbay.jetty.util.resource;
...
public class ResourceTest extends junit.framework.TestCase
{
        ...
        throws Exception
    {
        ...
        __userURL = new URL(__userURL.toString() + "src/test/java/org/mortbay/jetty/util/resource/");
		...
		__relDir = "src/test/java/org/mortbay/jetty/util/resource/".replace('/', File.separatorChar);  
    ...
    {
        final String classPathName="/org/mortbay/jetty/util/resource/Resource.class";
