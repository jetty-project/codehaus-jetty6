...
public class ResourceCollectionTest extends TestCase
{
    ...
    public void testMutlipleSources1() throws Exception
    {
        ResourceCollection rc1 = new ResourceCollection(new String[]{
                "src/test/resources/org/mortbay/jetty/util/resource/one/",
                "src/test/resources/org/mortbay/jetty/util/resource/two/",
                "src/test/resources/org/mortbay/jetty/util/resource/three/"
        });
