...
public class Ajp13Generator extends AbstractGenerator
{
         ...
         *                 If the request is not expecting any more content, or
         *                 if the buffers are full and cannot be flushed.
         * @throws IOException
        ...
        public void completeHeader(HttpFields fields, boolean allContentAdded) throws IOException
        {
                ...
                try
                {
                        ...
                        addInt(_status);
                        if(_reason == null) _reason = getReasonBuffer(_status);
        ...
        public long flush() throws IOException
        {
                try
                {
                        if(!_needMore && _state == STATE_HEADER) throw new IllegalStateException("State==HEADER");
                        ...
                        if(_endp == null)
                        {
                                ...
                                // }
                                if(!_needMore && _needEOC && _buffer != null)
                                {
                                        _hasSentEOC = true;
                        ...
                        Flushing: while (true)
                        {
                                ...
                                case 0:
                                {
                                        ...
                                        if(!_needMore && !_needEOC && (_content == null || _content.length() == 0))
                                        {
                                                ...
                                                if(_state == STATE_END/* &&_close */) _endp.close();
        ...
        {
                return !_needMore && _state == STATE_END;
        }
