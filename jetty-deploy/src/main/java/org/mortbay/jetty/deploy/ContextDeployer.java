...
public class ContextDeployer extends AbstractLifeCycle
{
    ...
    protected class ScannerListener implements Scanner.DiscreteListener
    {
         ...
         * 
         * @see org.mortbay.jetty.server.server.util.Scanner.FileAddedListener#fileAdded(java.lang.String)
         */
         ...
         * 
         * @see org.mortbay.jetty.server.server.util.Scanner.FileChangedListener#fileChanged(java.lang.String)
         */
         ...
         * Handle an undeploy.
         * 
         * @see org.mortbay.jetty.server.server.util.Scanner.FileRemovedListener#fileRemoved(java.lang.String)
         */
