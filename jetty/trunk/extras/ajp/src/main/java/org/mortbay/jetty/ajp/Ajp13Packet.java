...
public class Ajp13Packet {
    ...
    public final static String
        ...
        // Server <- Container
        SEND_BODY_CHUNK = "SEND BODY CHUNK",
    ...
    public final static int
        FORWARD_REQUEST_ORDINAL = 2,
        SHUTDOWN_ORDINAL = 7,
        PING_REQUEST_ORDINAL = 8, // Obsolete
        CPING_REQUEST_ORDINAL = 10,
        SEND_BODY_CHUNK_ORDINAL = 3,
        SEND_HEADERS_ORDINAL = 4,
        END_RESPONSE_ORDINAL = 5,
        GET_BODY_CHUNK_ORDINAL = 6,
