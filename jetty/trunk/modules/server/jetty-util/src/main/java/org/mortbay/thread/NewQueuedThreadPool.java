...
public class NewQueuedThreadPool extends AbstractLifeCycle implements ThreadPool, Executor
{
    ...
    /* Construct
     */
    public NewQueuedThreadPool(int maxThreads)
    {
        this();
