...
public class AnnotationTest extends HttpServlet 
{
    ...
    {       
       ...
       try
       {
           ...
           envLookupResult = "java:comp/env/com.acme30.AnnotationTest/maxAmount="+ic.lookup("java:comp/env/com.acme30.AnnotationTest/maxAmount");
       }
       catch (Exception e)
       {
      ...
      {
          InitialContext ic = new InitialContext();
          envLookupResult3 = "java:comp/env/com.acme30.AnnotationTest/avgAmount="+ic.lookup("java:comp/env/com.acme30.AnnotationTest/avgAmount");
      }
      catch (Exception e)
      {
       ...
       {
           InitialContext ic = new InitialContext();
           dsLookupResult = "java:comp/env/com.acme30.AnnotationTest/myDatasource="+ic.lookup("java:comp/env/com.acme30.AnnotationTest/myDatasource");
       }
       catch (Exception e)
       {
       ...
       {
           InitialContext ic = new InitialContext();
           txLookupResult = "java:comp/env/com.acme30.AnnotationTest/myUserTransaction="+ic.lookup("java:comp/env/com.acme30.AnnotationTest/myUserTransaction");
       }
       catch (Exception e)
       {
