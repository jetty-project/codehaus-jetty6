...
public class Ajp13RequestHeaders extends BufferCache {
    ...
    public final static int
        ACCEPT_ORDINAL = 1,
        ACCEPT_CHARSET_ORDINAL = 2,
        ACCEPT_ENCODING_ORDINAL = 3,
        ACCEPT_LANGUAGE_ORDINAL = 4,
        AUTHORIZATION_ORDINAL = 5,
        CONNECTION_ORDINAL = 6,
        CONTENT_TYPE_ORDINAL = 7,
        CONTENT_LENGTH_ORDINAL = 8,
        COOKIE_ORDINAL = 9,
        COOKIE2_ORDINAL = 10,
        HOST_ORDINAL = 11,
        PRAGMA_ORDINAL = 12,
        REFERER_ORDINAL = 13,
        USER_AGENT_ORDINAL = 14;
    ...
    public final static Buffer
        ...
        COOKIE2_BUFFER = CACHE.add(COOKIE2, COOKIE2_ORDINAL),
