...
public class Ajp13ResponseHeaders extends BufferCache {
    ...
    public final static int
        CONTENT_TYPE_ORDINAL = 1,
        CONTENT_LANGUAGE_ORDINAL = 2,
        CONTENT_LENGTH_ORDINAL = 3,
        DATE_ORDINAL = 4,
        LAST_MODIFIED_ORDINAL = 5,
        LOCATION_ORDINAL = 6,
        SET_COOKIE_ORDINAL = 7,
        SET_COOKIE2_ORDINAL = 8,
        SERVLET_ENGINE_ORDINAL = 9,
        STATUS_ORDINAL = 10,
        WWW_AUTHENTICATE_ORDINAL = 11;
    ...
    public final static Buffer
        ...
        STATUS_BUFFER = CACHE.add(STATUS, STATUS_ORDINAL),
