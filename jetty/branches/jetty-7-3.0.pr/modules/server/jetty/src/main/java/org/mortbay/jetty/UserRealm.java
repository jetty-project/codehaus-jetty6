...
public interface UserRealm
{
     ...
     */
    public static final Principal NOBODY=new Principal()
    {
    ...
    /* ------------------------------------------------------------ */
    public static final Principal NOT_CHECKED=new Principal()
    {
        public String getName()
        {
            return "NOT CHECKED";
    ...
    /* ------------------------------------------------------------ */
    public static final Principal NO_USER=new Principal()
    {
        public String getName()
        {
            return "No User";
