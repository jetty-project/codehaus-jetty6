...
public class JettyHttpContext extends com.sun.net.httpserver.HttpContext
{
    ...
    private J2SEHTTPContextHandler _jettyContextHandler;
    ...
    {
        this._server = server;
        _jettyContextHandler = new J2SEHTTPContextHandler(this, handler);
        _jettyContextHandler.setContextPath(path);
    }

    protected J2SEHTTPContextHandler getJettyContextHandler()
    {
