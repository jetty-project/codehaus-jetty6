...
public class JmxServiceTest extends TestCase
{
        ...
        throws Exception
    {
        if (_run)
        {
            ...
            Resource configRes = Resource.newClassPathResource("/org/mortbay/jetty/monitor/jetty-monitor-service.xml");
    ...
    public void testThreadPoolMXBean()
        throws Exception
    {        
        // TODO: Launch external jetty process
        if(_run) {
        ...
        throws Exception
    {
        ...
        JMXServiceURL url = new JMXServiceURL("rmi", null, 0, "/jndi/rmi://localhost:1099/jettyjmx");
        ConnectorServer connServer = new ConnectorServer(url,"org.eclipse.jetty:name=rmiconnectorserver");
        connServer.start();
