...
public class CGI extends HttpServlet
{
              ...
              throws ServletException, IOException
  {
    ...
    if (first.length()==0 || !exe.exists() || exe.isDirectory() ||
   ...
   */
  private void exec( File command, String pathInfo,
               ...
               throws IOException
  {
    ...
    Process p = (dir==null) ? Runtime.getRuntime().exec(execCmd, env.getEnvArray())
