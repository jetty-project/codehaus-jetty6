...
public interface SessionManager extends LifeCycle
{
     ...
     * Defaults to jsessionid, but can be set with the
     * org.mortbay.jetty.servlet.SessionIdPathParameterName context init parameter.
     * If set to null or "none" no URL rewriting will be done.
     */
    public final static String __SessionIdPathParameterNameProperty = "org.mortbay.jetty.servlet.SessionIdPathParameterName";
